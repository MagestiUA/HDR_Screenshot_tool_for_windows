...
На Windows 11 з увімкненим **Smart App Control** exe може бути заблокований з повідомленням _«Smart App Control заблокував потенційно небезпечний застосунок»_. Це очікувана поведінка для непідписаних файлів від невідомих розробників.

**Варіант 1 — вимкнути Smart App Control** (одноразово, не впливає на загальну безпеку системи):
> Параметри → Конфіденційність і захист → Безпека Windows → Керування додатками і браузером → Smart App Control → **Вимкнути**

**Варіант 2 — запустити з вихідного коду** (без жодних дозволів):
```bash
python main.py
```
